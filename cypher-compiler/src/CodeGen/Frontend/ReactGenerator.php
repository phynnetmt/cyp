...
use Cypher\Compiler\AST\{
    ...
    VarDeclStmt, SayStmt, ExpressionStmt, CallExpr,
...
class ReactGenerator
{
    ...
    private function generateProjectFiles(): void
    {
        ...
        $this->generatedFiles['frontend/vite.config.ts'] = $header . <<<'TS'
...
TS;
        ...
        $this->generatedFiles['frontend/tailwind.config.js'] = $header . <<<'JS'
...
JS;
        ...
        $this->generatedFiles['frontend/postcss.config.js'] = $header . <<<'JS'
export default {
    plugins: {
        tailwindcss: {},
        autoprefixer: {},
...
JS;
        ...
        $this->generatedFiles['frontend/index.html'] = $header . <<<'HTML'
<!DOCTYPE html>
...
CSS;
        ...
        $this->generatedFiles['frontend/src/main.tsx'] = $header . <<<'TSX'
...
TSX;
        ...
        $this->generatedFiles['frontend/src/vite-env.d.ts'] = "/// <reference types=\"vite/client\" />\n";
    }
    ...
    private function generateAppShell(): void
    {
        ...
        $this->generatedFiles['frontend/src/App.tsx'] = $header . <<<'TSX'
import React from 'react';
...
TSX;
        ...
        $this->generatedFiles['frontend/src/components/Layout.tsx'] = $header . <<<'TSX'
import React from 'react';
...
TSX;
    ...
    private function generateAPIclient(): void
    {
        ...
        $this->generatedFiles['frontend/src/lib/api.ts'] = $header . <<<'TS'
...
TS;
    ...
    {
        $this->generatedFiles['frontend/src/routes.ts'] = $this->autoGeneratedNote('//') . <<<'TS'
...
TS;
    ...
    {
        return $this->autoGeneratedNote('//') . "import {$page} from './pages/{$page}';\n\nexport const routes = [\n    { path: '{$path}', element: {$page} },\n];\n";
    }
